"""A collection of auxiliary functions that are commonly used.
"""
...
# sequence: ordered list of tuples ("z", index), ("y", index) or ("x", index, b0) where b0 is optional and automatically determined if not given
